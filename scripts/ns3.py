...
def main(argv):
    ...
    tapBridge.SetAttribute("Mode", ns.core.StringValue("UseBridge"))
    tapBridge.SetAttribute("DeviceName", ns.core.StringValue("tap0"))
    ...
    # ghost node.
    #
    tapBridge.SetAttribute("DeviceName", ns.core.StringValue("tap1"))
    tapBridge.Install(nodes.Get(1), devices.Get(1))

    #
    # Run the simulation for ten minutes to give the user time to play around
    #
    ns.core.Simulator.Stop(ns.core.Time(10000000000))
